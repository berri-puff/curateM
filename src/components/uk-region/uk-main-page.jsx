            ...
            <Link to={`/uk/${artwork.systemNumber}`} key={artwork.systemNumber}>
              <ol>
                ...
                <Link to={`/uk/${artwork.systemNumber}`}>
                  <img src={artwork["_images"]["_primary_thumbnail"]? artwork["_images"]["_primary_thumbnail"] : 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/660px-No-Image-Placeholder.svg.png?20200912122019'}></img>{" "}
                </Link>
