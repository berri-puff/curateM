...
const UKRegion = () => {
  ...
  <section id="art-container">
    ...
    <header className="card-header center has-text-black">
                  {artwork["_primaryTitle"] ?  <p id="artwork-title" className="card-header-title has-text-black">{artwork["_primaryTitle"]}</p> : <p id="artwork-title" className="card-header-title has-text-black">Untitled</p>}  
            </header>
