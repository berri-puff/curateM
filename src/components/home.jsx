  ...
  return (
    <main>
      ...
      <section id="main-left">
        <img
          src="src/components/photos/nav.png"
      ...
      <section id="main-right">
        ...
        <img
          width={550}
          height={660}
          src="src/components/photos/uk-filtered.png"
          alt="image of different artwork on this website from UK API sources"
        />
      </section>
      <section id="main-left">
        <img
          src="src/components/photos/us-filter.png"
          width={550}
          height={660}
      ...
      <section id="main-right">
        ...
        <img
          src="src/components/photos/single-location.png"
          width={550}
          height={660}
      ...
      <section id="main-left">
        <img
          src="src/components/photos/exh.png"
          width={550}
          height={660}
